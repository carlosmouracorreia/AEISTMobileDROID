...
public class AeistFrag extends Fragment {
	...
	public class PelouroContainer {
	    ...
	    public View onCreateView(LayoutInflater inflater, ViewGroup container,
	        ...
	        PelouroContainer p1 = new PelouroContainer("PresidÃªncia");
	        ...
	        PelouroContainer p2 = new PelouroContainer("GestÃ£o e ServiÃ§os");
	        ...
	        p2.addPessoa(new Pessoa("Carlos Correia","Vogal - Programador desta AplicaÃ§Ã£o","http://mobile.aeist.pt/dAEISTpics/gs/eu.jpg","carlos.correia@aeist.pt"));
	        ...
	        p2.addPessoa(new Pessoa("JosÃ© Barbosa","Colaborador","http://mobile.aeist.pt/dAEISTpics/gs/joka.jpg","jose.barbosa@aeist.pt"));
	        ...
	        PelouroContainer p3 = new PelouroContainer("ComunicaÃ§Ã£o");
	        ...
	        p3.addPessoa(new Pessoa("InÃªs Urbano","Vogal","http://mobile.aeist.pt/dAEISTpics/comunic/urbano.jpg","ines.urbano@aeist.pt"));
	        ...
	        p3.addPessoa(new Pessoa("JoÃ£o TomÃ¡zio","Colaborador","http://mobile.aeist.pt/dAEISTpics/comunic/tomazio.jpg","joao.tomazio@aeist.pt"));
	        ...
	        p4.addPessoa(new Pessoa("Rodrigo LourenÃ§o","Coordenador","http://mobile.aeist.pt/dAEISTpics/desporto/rodrigolourenco.jpg","rodrigo.lourenco@aeist.pt"));
	        p4.addPessoa(new Pessoa("Afonso GonÃ§alves","Vogal","http://mobile.aeist.pt/dAEISTpics/desporto/afonsogoncalves.jpg","afonso.goncalves@aeist.pt"));
	        p4.addPessoa(new Pessoa("InÃªs Daniel","Colaboradora","http://mobile.aeist.pt/dAEISTpics/desporto/inesdaniel.jpg","ines.daniel@aeist.pt"));
	        ...
	        p4.addPessoa(new Pessoa("JoÃ£o Reis","Colaborador","http://mobile.aeist.pt/dAEISTpics/desporto/joaoreis.jpg","joao.reis@aeist.pt"));
	        pelouroList.add(p4);
	        ...
	        p5.addPessoa(new Pessoa("JosÃ© Rego","Vogal","http://mobile.aeist.pt/dAEISTpics/gefe/joserego.jpg","jose.rego@aeist.pt"));
	        ...
	        PelouroContainer p8 = new PelouroContainer("PolÃ­tica Educativa");
	        ...
	        p6.addPessoa(new Pessoa("Ricardo CardÃ£o","Vogal","http://mobile.aeist.pt/dAEISTpics/recreativa/ricardocardao.jpg","ricardo.cardao@aeist.pt"));
	        p6.addPessoa(new Pessoa("Valdo Lopes","Vogal","http://mobile.aeist.pt/dAEISTpics/recreativa/valdolopes.jpg","valdo.lopes@aeist.pt"));
	        p6.addPessoa(new Pessoa("AntÃ³nio Morgado","Vogal","http://mobile.aeist.pt/dAEISTpics/recreativa/antoniomorgado.jpg","antonio.morgado@aeist.pt"));
	        ...
	        p6.addPessoa(new Pessoa("AndrÃ© Paluch","Colaborador","http://mobile.aeist.pt/dAEISTpics/recreativa/andrepaluch.jpg","andre.paluch@aeist.pt"));
	        p6.addPessoa(new Pessoa("JoÃ£o Carvalho","Colaborador","http://mobile.aeist.pt/dAEISTpics/recreativa/joaocarvalho.jpg","joao.carvalho@aeist.pt"));
	        pelouroList.add(p6);
	        ...
	        p7.addPessoa(new Pessoa("AntÃ³nio Fitas","Vogal","http://mobile.aeist.pt/dAEISTpics/cultural/antoniofitas.jpg","antonio.fitas@aeist.pt"));
	        p7.addPessoa(new Pessoa("Valdo Lopes","Vogal","http://mobile.aeist.pt/dAEISTpics/recreativa/valdolopes.jpg","valdo.lopes@aeist.pt"));
	        p7.addPessoa(new Pessoa("Paloma GonÃ§alves","Colaboradora","http://mobile.aeist.pt/dAEISTpics/cultural/palomagoncalves.jpg","paloma.goncalves@aeist.pt"));
	        pelouroList.add(p7);
	        
	        PelouroContainer p9 = new PelouroContainer("RelaÃ§Ãµes Internas e Associados");
	        ...
	        p9.addPessoa(new Pessoa("JoÃ£o Sabino","Vogal","http://mobile.aeist.pt/dAEISTpics/ria/joaosabino.jpg","joao.sabino@aeist.pt"));
	        p9.addPessoa(new Pessoa("Edgar Ramalho","Colaborador","","edgar.ramalho@aeist.pt"));
	        p9.addPessoa(new Pessoa("AndrÃ© Costa","Colaborador","http://mobile.aeist.pt/dAEISTpics/ria/andrecosta.jpg","andre.costa@aeist.pt"));
	        p9.addPessoa(new Pessoa("Bernardo Caldeira","Colaborador","","bernardo.caldeira@aeist.pt"));
	        pelouroList.add(p9);
	        
	        PelouroContainer p10 = new PelouroContainer("RelaÃ§Ãµes Externas");
	        p10.addPessoa(new Pessoa("InÃªs Henriques","Coordenadora","http://mobile.aeist.pt/dAEISTpics/re/ineshenriques.jpg","ines.henriques@aeist.pt"));
	        ...
	        p11.addPessoa(new Pessoa("JoÃ£o Valado","Coordenador","http://mobile.aeist.pt/dAEISTpics/joaovalado.jpg","joao.valado@aeist.pt"));
	        pelouroList.add(p11);
